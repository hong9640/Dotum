...
import WordResultsList from '@/features/result-list/components/WordResultsList';
import ActionButtons from '@/features/result-list/components/ActionButtons';
import MetricCard from '@/features/result-list/components/MetricCard';
          ...
          <div className="p-6 flex flex-col md:flex-row justify-start items-center gap-6 w-full min-w-0">
            ...
            <div className="p-8 bg-white rounded-2xl shadow-lg inline-flex flex-col justify-start items-start gap-3.5 flex-1 min-w-0">
              <div className="w-full flex flex-col justify-start items-stretch gap-4">
                <MetricCard title="CPP" value={mockVoiceMetrics.cpp} />
                <MetricCard title="CSID" value={mockVoiceMetrics.csid} />
              </div>
