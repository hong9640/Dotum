...
│       ├── mpt.tsx                 # 최대 발성 지속 시간 연습 (MPT)
│       ├── crescendo.tsx           # 크레셴도 연습 (점강)
│       ├── decrescendo.tsx         # 데크레셴도 연습 (점약)
│       ├── loud-soft.tsx           # 순간 강약 전환 연습
│       └── soft-loud.tsx           # 연속 강약 조절 연습
│
└── api/
...
1. 소개 페이지 (/voice-training)
   ...
   - 연습 방법 설명
   ↓
2. MPT 연습 (/voice-training/mpt?attempt=1~3)
   - 최대 발성 지속 시간 연습
   - 3회 시도
   ↓
3. 크레셴도 연습 (/voice-training/crescendo?attempt=1~3)
   - 점점 크게 발성
   - 3회 시도
   ↓
4. 데크레셴도 연습 (/voice-training/decrescendo?attempt=1~3)
   - 점점 작게 발성
   - 3회 시도
   ↓
5. 순간 강약 전환 연습 (/voice-training/loud-soft?attempt=1~3)
   - 크게 → 작게 변화
   - 3회 시도
   ↓
6. 연속 강약 조절 연습 (/voice-training/soft-loud?attempt=1~3)
   - 작게 → 크게 변화
   - 3회 시도
   ↓
완료 → 홈으로 이동
...
├── getTrainingHistory.ts   # 연습 이력 조회
└── submitTrainingResult.ts # 연습 결과 제출
```
