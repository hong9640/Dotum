...
const CrescendoPage: React.FC = () => {
  ...
  const handlePrev = () => {
    if (attempt > 1) {
      ...
      navigate(`/voice-training/mpt?attempt=3&sessionId=${sessionId}`);
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="border-0 shadow-none">
          <CardContent className="p-6 sm:p-8">
            ...
            {isCompleted && (
              <div className="mb-6 p-4 bg-teal-50 rounded-xl border-2 border-teal-200 text-center">
            ...
            <div className="flex justify-center pt-4">
              <Button
                ...
                className="min-w-[240px] px-8 py-6 text-xl bg-teal-500 hover:bg-teal-600 text-white font-semibold rounded-xl flex items-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {attempt < 3 ? (
                  <>
                    다음 시도 ({attempt + 1}/3)
