  ...
  return (
    <div className="p-8 sm:p-10 bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl border-3 border-yellow-300 shadow-sm mb-8 text-center">
      ...
      <div className="flex justify-center items-end gap-1 mb-4">
        {[...main].map((char, i) => {
          // 데크레셴도: 더크 → 크 → 중 → 작 (80 → 64 → 48 → 32)
          const sizes = [80, 64, 48, 32];
          return (
            <span
              key={i}
      ...
      <div className="inline-block px-4 py-2 bg-yellow-200/50 rounded-lg mb-4">
        ...
        <div className="flex justify-center mt-4">
          <Button
            ...
            className={`
              ...
              ${isSpeaking 
                ? 'bg-yellow-500 border-yellow-500 text-white cursor-not-allowed opacity-70' 
